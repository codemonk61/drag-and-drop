...
export default function IconCard({ props }) {
  const icon = ICONS[props.icon] || ICONS.bolt;

  return (
    <div style={{ textAlign: 'center', padding: `${props.padding || 24}px` }}>
      <div
        style={{
          width: `${props.iconSize || 48}px`,
          height: `${props.iconSize || 48}px`,
          margin: '0 auto 16px',
          color: props.iconColor || props.textColor || '#ffffff',
        }}
      >
        {props.iconImage ? (
          <img src={props.iconImage} alt="" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
        ) : icon}
      </div>
      <h3 style={{
